...
<head>
    ...
    <title><?= $sett_web['jdl_web'] ?> - <?= $sett_web['desc_web'] ?></title>
    <link rel="shortcut icon" href="<?= base_url() ?>assets/setting/<?= $sett_web['icon_web'] ?>" />

    <link href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i|Ubuntu:300,300i,400,400i,500,500i,700,700i" rel="stylesheet">

    <link rel="stylesheet" href="<?= base_url() ?>assets/utama/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/css/jquery.mCustomScrollbar.css" />

    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/owl-carousel/owl.carousel.css" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/owl-carousel/owl.theme.css" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/owl-carousel/owl.transitions.css" />

    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/css/RYPP.css" />

    <link rel="stylesheet" href="<?= base_url() ?>assets/utama/css/jquery-ui.css">

    <link rel="stylesheet" href="<?= base_url() ?>assets/utama/css/animate.min.css">

    <link rel="stylesheet" href="font-awesome/<?= base_url() ?>assets/utama/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/css/Pe-icon-7-stroke.css" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/utama/css/flaticon.css" />
...
<body>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-4 col-sm-4">
                        <div class="header-logo">
                            <a href="<?= base_url() ?>">
                                <img class="td-retina-data img-responsive" src="<?= base_url() ?>assets/setting/<?= $sett_web['logo_1'] ?>" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-8 col-md-8 col-sm-8 hidden-xs">
                        <div class="header-banner">
                            <a href="#"><img class="td-retina img-responsive" src="<?= base_url() ?>assets/setting/<?= $sett_web['ads_1'] ?>" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <nav class="navbar">
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?= base_url() ?>daftar-isi-website" class="category08">DAFTAR ISI</a></li>
                    </ul>
                </div>
            ...
            <div class="row row-margin">
                <div class="col-sm-6 col-padding">
                    <div class="post-wrapper post-grid-6 wow fadeIn" data-wow-duration="2s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb-top" src="<?= base_url() ?>assets/utama/images/slider/slide-11.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div class="col-sm-6 col-padding">
                    <div class="post-wrapper post-grid-7 wow fadeIn" data-wow-duration="2s">
                        <div class="post-thumb img-zoom-in">
                            <a href="#">
                                <img class="entry-thumb-top" src="<?= base_url() ?>assets/utama/images/slider/slide-12.jpg" alt="">
                            </a>
                        </div>
                        <div class="post-info">
                ...
                <div id="content-slide-4" class="owl-carousel">
                    <div class="item">
                        <div class="post-wrapper post-grid-8 wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb-bottom" src="<?= base_url() ?>assets/utama/images/slider/slide-13.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper post-grid-9 wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb-bottom" src="<?= base_url() ?>assets/utama/images/slider/slide-14.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper post-grid-10 wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb-bottom" src="<?= base_url() ?>assets/utama/images/slider/slide-15.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper post-grid-10 wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb-bottom" src="<?= base_url() ?>assets/utama/images/slider/slide-16.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                    ...
                    <div class="item">
                        <div class="post-wrapper post-grid-10 wow fadeIn" data-wow-duration="2s">
                            <div class="post-thumb img-zoom-in">
                                <a href="#">
                                    <img class="entry-thumb-bottom" src="<?= base_url() ?>assets/utama/images/slider/slide-17.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-info">
                ...
                <div class="col-sm-8">
                    <div class="articale-list">
                        ...
                        <div class="post-style2 wow fadeIn" data-wow-duration="1s">
                            <a href="#"><img src="<?= base_url() ?>assets/utama/images/category/category-post-11.jpg" alt=""></a>
                            <div class="post-style2-detail">
                                <h3><a href="#" title="">It uses a dictionary of over 200 Latin words, combined with</a></h3>
                                <div class="date">
                                    <ul>
                                        <li><img src="<?= base_url() ?>assets/utama/images/comment-01.jpg" class="img-responsive" alt=""></li>
                        ...
                        <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <a href="#"><img src="<?= base_url() ?>assets/utama/images/category/category-post-12.jpg" alt=""></a>
                            <div class="post-style2-detail">
                                <h3><a href="#" title="">Lorem Ipsum is simply dummy text of the printing .</a></h3>
                                <div class="date">
                                    <ul>
                                        <li><img src="<?= base_url() ?>assets/utama/images/comment-02.jpg" class="img-responsive" alt=""></li>
                                        <li>By <a title="" href="#"><span>Naeem Khan</span></a> --</li>
                                        <li><a title="" href="#">Oct 6, 2016</a> --</li>
                                        <li><a title="" href="#"><span>275 Comments</span></a></li>
                                    </ul>
                        ...
                        <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a href="#"><img src="<?= base_url() ?>assets/utama/images/category/category-post-13.jpg" alt=""></a>
                            <div class="post-style2-detail">
                        ...
                        <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                            <a href="#"><img src="<?= base_url() ?>assets/utama/images/category/category-post-14.jpg" alt=""></a>
                            <div class="post-style2-detail">
                        ...
                        <div class="post-style2 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                            <a href="#"><img src="<?= base_url() ?>assets/utama/images/category/category-post-15.jpg" alt=""></a>
                            <div class="post-style2-detail">
                ...
                <div class="col-sm-4 left-padding">
                    ...
                    <div class="widget-slider-inner">
                        ...
                        <div id="widget-slider" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <a href="#"><img src="<?= base_url() ?>assets/utama/images/slider-widget-1.jpg" alt=""></a>
                            ...
                            <div class="item">
                                <a href="#"><img src="<?= base_url() ?>assets/utama/images/slider-widget-2.jpg" alt=""></a>
                            ...
                            <div class="item">
                                <a href="#"><img src="<?= base_url() ?>assets/utama/images/slider-widget-3.jpg" alt=""></a>
                                <h4><a href="#">For good results must be make good plan</a></h4>
                                <div class="date">
                                    <ul>
                                        <li>By<a title="" href="#"><span>Jone Kilna</span></a> --</li>
                    ...
                    <div class="latest-comments-inner">
                        ...
                        <div class="post-style2 latest-com">
                            <img src="<?= base_url() ?>assets/utama/images/comment-01.jpg" alt="">
                        ...
                        <div class="post-style2 latest-com">
                            <img src="<?= base_url() ?>assets/utama/images/comment-02.jpg" alt="">
                            <div class="latest-com-detail">
                                <h5><a href="#" title="">It uses a dictionary of over</a></h5>
                                <span>Nec sagittis sem nibh dictionary...</span>
                                <p>Proin gravida nibh vel velit auctor aliquet. </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-8">
                        ...
                        <div id="content-slide" class="owl-carousel">
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_01.jpg" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_02.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info meta-info-rn">
                                        <div class="slide">
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_03.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info meta-info-rn">
                                        <div class="slide">
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_04.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info meta-info-rn">
                                        <div class="slide">
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_05.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info meta-info-rn">
                                        <div class="slide">
                            ...
                            <div class="item home2-post">
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                    ...
                                    <div class="post-thumb">
                                        <a href="#">
                                            <img class="img-responsive" src="<?= base_url() ?>assets/utama/images/recent_news_06.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info meta-info-rn">
                                        <div class="slide">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="home2-post">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img src="<?= base_url() ?>assets/utama/images/politics_01.jpg" class="img-responsive" alt="">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                        <a href="#">
                                                            <img src="<?= base_url() ?>assets/utama/images/politics_02.jpg" class="img-responsive" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                                        <a href="#">
                                                            <img src="<?= base_url() ?>assets/utama/images/politics_03.jpg" class="img-responsive" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                                                        <a href="#">
                                                            <img src="<?= base_url() ?>assets/utama/images/politics_04.jpg" class="img-responsive" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="post-title-author-details">
                                            ...
                                            <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                                        <a href="#">
                                                            <img src="<?= base_url() ?>assets/utama/images/politics_05.jpg" class="img-responsive" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="post-title-author-details">
                ...
                <div class="ads">
                    <a href="#"><img src="<?= base_url() ?>assets/utama/images/top-bannner2.jpg" class="img-responsive center-block" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-4 left-padding">
                ...
                <div class="banner-add">
                    ...
                    <a href="#"><img src="<?= base_url() ?>assets/utama/images/ad-banner.jpg" class="img-responsive center-block" alt=""></a>
                </div>
                <div class="tab-inner">
                    <ul class="tabs">
                    ...
                    <div class="tab_content">
                        <div class="tab-item-inner">
                            <div class="box-item wow fadeIn" data-wow-duration="1s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_01.jpg" alt="" height="80" width="90"></a>
                                </div>
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_02.jpg" alt="" height="80" width="90"></a>
                                </div>
                                <div class="item-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_03.jpg" alt="" height="80" width="90"></a>
                                </div>
                                <div class="item-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_04.jpg" alt="" height="80" width="90"></a>
                                </div>
                                <div class="item-details">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="footer-box footer-logo-address">
                        ...
                        <img src="<?= base_url() ?>assets/utama/images/footer-logo.png" class="img-responsive" alt="">
                        <address>
                            14L.E Goulburn St, Sydney 2000NSW
                            <br> Tell: 01922296392
                            <br> Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6002041401130b20070d01090c4e030f0d">[email&#160;protected]</a>
                        </address>
                    </div>
                ...
                <div class="col-sm-4">
                    <div class="footer-box">
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="1s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_01.jpg" alt="" height="80" width="100"></a>
                            </div>
                            <div class="item-details">
                                <h6 class="sub-category-title bg-color-1">
                                    <a href="#">SPORTS</a>
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb" src="<?= base_url() ?>assets/utama/images/popular_news_02.jpg" alt="" height="80" width="100"></a>
                            </div>
                            <div class="item-details">
                                <h6 class="sub-category-title bg-color-2">
                                    <a href="#">TECHNOLOGY </a>
    ...
    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/jquery.min.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/bootstrap.min.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/metisMenu.min.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/jquery.mCustomScrollbar.concat.min.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/wow.min.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/jquery.newsTicker.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/classie.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/owl-carousel/owl.carousel.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/RYPP.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/jquery-ui.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/form-classie.js"></script>

    <script type="text/javascript" src="<?= base_url() ?>assets/utama/js/custom.js"></script>
</body>
